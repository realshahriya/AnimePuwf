...
export default function TrendingCardsPage() {
  return (
    <main className="w-full max-w-7xl mx-auto px-6 py-20 flex-grow text-light-ash text-center">
      <h1 className="font-heading text-4xl md:text-5xl font-bold mb-4 text-puwf-fire drop-shadow-md">Most Shared Cards</h1>
