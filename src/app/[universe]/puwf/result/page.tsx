...
interface ResultState extends PuwfResult {
  userName: string;
}
...
export default function PuwfResultPage({ params }: { params: Promise<{ universe: string }> }) {
  ...
  return (
    <main className="w-full max-w-5xl mx-auto px-6 pt-32 pb-12 text-light-ash flex flex-col items-center min-h-[80vh]">
      <motion.div
      ...
      >
        ...
        <h1 className="font-heading text-4xl md:text-5xl font-extrabold text-white mb-4 tracking-tight drop-shadow-xl">
          Artifact Forged
        </h1>
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8 mt-20 opacity-50 hover:opacity-100 transition-opacity">
        <div className="p-8 rounded-2xl bg-eclipse-black/40 border border-light-ash/5 backdrop-blur-md">
        ...
        <div className="p-8 rounded-2xl bg-eclipse-black/40 border border-light-ash/5 backdrop-blur-md flex flex-col justify-center">
