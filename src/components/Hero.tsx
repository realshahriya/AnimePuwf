...
export default function Hero() {
  return (
    <section className="w-full flex flex-col items-center text-center pt-32 pb-24 px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center max-w-5xl">
        ...
        <h1 className="font-heading text-5xl md:text-7xl font-bold tracking-tight text-white mb-6 drop-shadow-lg">
        ...
        {/* Body text => Light Ash */}
        <p className="text-light-ash/90 text-lg md:text-xl max-w-2xl mb-10 leading-relaxed drop-shadow-md">
